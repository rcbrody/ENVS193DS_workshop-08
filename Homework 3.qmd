...
ggplot(drought_exp_clean, aes(x = water_treatment, y = total_g)) +
  ...
  labs(x = "Water Treatment", y = "Total Mass (g)") + #change axis titles
...
**The model that best predicted the total plant mass was the one that included only species and water treatment as predictors (model stats). On average,------. On average,..... **
...
**For my personal data collected about my cat's scratching behavior, I could create a**
